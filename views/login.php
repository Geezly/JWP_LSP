    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body::before {
            ...
            inset: 0;
            background-image:
                radial-circle(circle at 15% 85%, rgba(107,63,38,0.06) 0%, transparent 50%),
                radial-circle(circle at 85% 15%, rgba(160,103,74,0.05) 0%, transparent 50%);
            pointer-events: none;
        }
...
<div class="wrapper">
    ...
    <div class="panel-left">
        <div class="brand">
            ...
            <p class="brand-tagline">Selamat<br><em>Datang</em><br>Kembali.</p>
        </div>
        <div class="panel-quote">
            <div class="quote-line"></div>
            <p class="quote-text">Masuk untuk mengakses<br>semua fitur yang tersedia<br>bagi Anda.</p>
        </div>
    </div>
    ...
    <div class="panel-right">
        <div class="form-header">
            ...
            <p class="form-subtitle">Gunakan kredensial Anda untuk melanjutkan</p>
        </div>
